...
using System;
using StoreSample.Queries.Infrastructure.Swagger;
using MongoDB.Driver;
using Microsoft.Extensions.Hosting;
using StoreSample.Queries.HostedServices;

namespace StoreSample.Queries
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                options.OperationFilter<RouteParamsFilter>();
            });
            ...
            services.AddSingleton<IHostedService, EventsSubscriber>();
        }
